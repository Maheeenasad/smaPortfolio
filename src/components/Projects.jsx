                ...
                <Tab.Container id="projects-tabs" defaultActiveKey="first">
                  ...
                  <Tab.Content id="slideInUp" className={isVisible ? "animate__animated animate__slideInUp" : ""}>
                    <Tab.Pane eventKey="first">
                      <p>These designs were built using HTML, CSS, JavaScript and Reactjs along with the Bootstrap framework for responsive design.</p>
                      <Row>
                        {
                    ...
                    <Tab.Pane eventKey="second">
                      <p> I have designed and developed several simple games using HTML, CSS, and JavaScript. Each game was created with the goal of providing a fun and engaging experience for users while also helping me improve my skills as a game developer.</p>
                      <Row>
                        {
                    ...
                    <Tab.Pane eventKey="third">
                      <p>As a UI/UX designer, I am passionate about creating intuitive and engaging interfaces that help users achieve their goals. My design philosophy is centered around user-centric design principles, including simplicity, consistency, and empathy. I believe that great design should be both functional and visually appealing, and should always prioritize the user's needs and expectations.</p>
                      <Row>
                        {
